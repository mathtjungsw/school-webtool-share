...
export const WORK_ASSISTANT_ENTRIES: WorkAssistantEntry[] = [
  ...
  },
  {
    ...
    summary: '그룹 없이 모두 표시되는 왼쪽 메뉴를 원하는 순서로 끌어 놓고 현재 PC에 저장합니다.',
    steps: ['왼쪽 메뉴에 마우스를 올려 펼칩니다.', '목록 순서 변경을 누릅니다.', '각 메뉴 오른쪽 이동 손잡이를 끌어 원하는 위치에 놓은 뒤 순서 변경 완료를 누릅니다.', '초기화 버튼을 누르면 기본 순서로 돌아갑니다.'],
