...
export const WORK_ASSISTANT_ENTRIES: WorkAssistantEntry[] = [
  {
    ...
    summary: '관리자 전용 화면에서 공용 NEIS 상태를 확인하고 13:00까지 기다리지 않고 급식·NEIS 학사일정·학급시간표 10일치를 즉시 갱신합니다.',
    steps: ['상단 사용자 버튼에서 관리자 모드를 시작합니다.', '왼쪽 관리자 센터 메뉴를 엽니다.', '이 PC가 동기화 PC이고 API 키가 저장되어 있는지 상태를 확인합니다.', '급식·학사일정·학급시간표 지금 동기화 버튼을 누릅니다.', '항목별 갱신 건수와 실패 여부를 확인합니다. 한 항목이 실패해도 성공한 항목은 갱신되고 실패 항목은 기존 자료가 유지됩니다.'],
    keywords: ['관리자 센터', '관리자 전용 탭', '관리자 동기화', '즉시 동기화', '지금 동기화', '10일치 동기화', '13시 동기화', 'NEIS 수동 갱신', '공용 자료 갱신', '급식 동기화', '학사일정 동기화', '학급시간표 동기화', '일부 동기화'],
  },
  {
  ...
  },
  {
    ...
    steps: ['환경설정에서 본인 이름을 정확히 등록합니다.', '캘린더를 열면 공개 시트에서 이름이 일치하는 등교지도와 급식지도 일정이 자동 표시됩니다.', '날짜를 선택해 시간과 장소를 확인하며, 새로고침하면 원본 시트 변경 내용을 다시 불러옵니다.'],
  ...
  },
  {
    ...
    summary: '1·2·3학년 학생의 학번 4·5자리 또는 이름을 입력해 현재 수업, 담당 교사와 교실을 확인합니다.',
    steps: ['학생 위치 찾기 메뉴를 엽니다.', '1·2·3학년 학생의 학번 또는 이름을 입력합니다.', '동명이인이면 진하게 표시된 학번·학급을 확인해 한 명을 선택합니다.', '현재 교시의 수업·교실·담당 교사를 확인합니다. 1학년은 학교 학생 명렬과 공용 학급시간표를 함께 사용하며 승인된 교환·대강도 자동 반영됩니다.'],
    keywords: ['학생 위치', '학생 찾기', '어느 교실', '현재 수업', '학생 교실', '학번 검색', '이름 검색', '동명이인', '학생 어디', '1학년 학생', '일학년 위치'],
  },
  {
