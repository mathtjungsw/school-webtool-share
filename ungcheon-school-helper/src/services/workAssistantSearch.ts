...
export const WORK_ASSISTANT_ENTRIES: WorkAssistantEntry[] = [
  ...
  },
  {
    ...
    summary: '대시보드에서 일요일부터 시작하는 2주 일정과 날씨·급식, 오른쪽 내 주간 시간표를 한눈에 확인합니다.',
    steps: ['대시보드를 엽니다.', '왼쪽 2주 달력을 일요일부터 토요일 순서로 확인하고, 그 아래 선택 일정·주간 참고사항을 확인합니다.', '달력 아래의 날씨·급식과 오른쪽 주간 시간표를 확인하거나 월간 캘린더 버튼으로 전체 달력을 엽니다.'],
    keywords: ['대시보드 달력', '2주 달력', '일요일 시작', '일요일부터', '이번 주 일정', '다음 주 일정', '대시보드 시간표', '주간 시간표', '달력 옆 시간표', '월간 캘린더 바로가기', '대시보드 날씨', '대시보드 급식'],
    teacherContext: true,
  },
  {
    id: 'monthly-calendar', title: '월간 통합 캘린더 보기', page: 'calendar', category: '일정',
    summary: '일요일부터 시작하는 월간 달력에서 NEIS 학사일정·주간계획·내 위원회·개인 업무를 확인합니다.',
    steps: ['캘린더 메뉴를 엽니다. 월간 달력은 일요일부터 토요일 순서로 표시되며, 앱 실행 중 한 번 불러온 월은 임시 캐시에서 먼저 표시됩니다.', '이전 달·다음 달 버튼으로 월을 이동합니다.', '날짜를 선택하면 그날의 전체 일정이 표시되며 서버 변경 내용은 뒤에서 갱신됩니다.'],
    keywords: ['월간 캘린더', '통합 캘린더', '일요일 시작', '일요일부터', '한달 일정', '학교 일정', '이번달 일정', '학사 일정', '주간 계획', '달력 보기', '캘린더 새로고침', '일정 캐시', '일정이 늦게 떠요'],
  },
  {
