...
export const WORK_ASSISTANT_ENTRIES: WorkAssistantEntry[] = [
  ...
  },
  {
    ...
    summary: '대시보드에서 왼쪽 2주 일정과 날씨·급식, 오른쪽 내 주간 시간표를 한눈에 확인합니다.',
    steps: ['대시보드를 엽니다.', '왼쪽 2주 달력과 그 아래 선택 일정·주간 참고사항을 확인합니다.', '달력 아래의 날씨·급식과 오른쪽 주간 시간표를 확인하거나 월간 캘린더 버튼으로 전체 달력을 엽니다.'],
    keywords: ['대시보드 달력', '2주 달력', '이번 주 일정', '다음 주 일정', '대시보드 시간표', '주간 시간표', '달력 옆 시간표', '월간 캘린더 바로가기', '대시보드 날씨', '대시보드 급식'],
    teacherContext: true,
  },
  {
