...
export const WORK_ASSISTANT_ENTRIES: WorkAssistantEntry[] = [
  ...
  },
  {
    ...
    summary: '교장·교감 우선 및 가나다순으로 정리된 교직원의 직책·부서·교과·담임 정보를 조회하고 내려받습니다.',
    steps: ['교직원 명렬 메뉴를 엽니다.', '직책·부서·교과·담임 정보를 조회하거나 내려받습니다.', '관리자 모드에서 “교직원 명렬 추가”를 누르면 새 행이 맨 아래에 생깁니다.', '내용을 입력하고 공유 명렬 저장을 누르면 교장·교감 우선, 나머지는 가나다순으로 자동 배치됩니다.'],
