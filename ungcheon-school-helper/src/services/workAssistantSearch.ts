...
export const WORK_ASSISTANT_ENTRIES: WorkAssistantEntry[] = [
  ...
  {
    id: 'staff-task', title: '업무 체크리스트 등록·확인', page: 'staff_tasks', category: '학교운영',
    summary: '교원·부서별 업무를 배부하고 교사별 완료 여부를 확인합니다.',
    steps: ['업무 체크리스트 메뉴를 엽니다.', '업무를 등록하고 대상 교원 또는 부서를 선택합니다.', '응답 현황에서 완료 여부를 확인합니다.'],
    keywords: ['업무 체크리스트', '교사 할 일', '부서 업무', '업무 배부', '업무 완료 확인', '체크 목록'],
  },
  {
  ...
  },
  {
    ...
    summary: '교장·교감 우선 및 가나다순으로 정리된 교원 명렬을 조회하고 내려받습니다.',
    steps: ['교원 명렬 메뉴를 엽니다.', '명렬을 조회하거나 내려받습니다.', '명렬 교체는 관리자 모드에서 Excel을 업로드합니다.'],
    keywords: ['교원 명렬', '교직원 명단', '선생님 명단', '교원명렬 다운로드', '교직원 목록'],
  },
  {
