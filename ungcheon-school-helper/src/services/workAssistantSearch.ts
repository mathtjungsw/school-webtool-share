...
export const WORK_ASSISTANT_ENTRIES: WorkAssistantEntry[] = [
  ...
  },
  {
    ...
    summary: '2027 경남교육청 기준으로 근무경력점·교육활동경력점·가산점을 합산하고 세부 산출표를 출력합니다.',
    steps: ['전보내신점수 계산기 메뉴를 엽니다.', '평정기준일과 휴직 등을 제외한 실제 근무기간·급지를 입력합니다. 웅천고는 라급지로 기본 설정됩니다.', '담임·부장 등 교육활동 인정 월수와 표창·상장·우대조건을 입력합니다.', '중복·상한 경고와 점수 내역을 확인한 뒤 인쇄·PDF로 저장합니다.'],
    keywords: ['전보내신점수', '전보 내신', '내신 점수', '내신이동', '일반교사 전보', '전보 점수', '근무경력점', '급지 점수', '교육활동경력점', '전보 가산점', '라급지', '내 점수 계산'],
    teacherContext: true,
  },
  {
