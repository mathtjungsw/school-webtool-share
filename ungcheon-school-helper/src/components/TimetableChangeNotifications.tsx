...
export default function TimetableChangeNotifications() {
  ...
  const load = useCallback(async () => {
    ...
    try { setItems((await listTimetableChanges(teacherName)).filter(item => ['pending', 'held', 'rejected'].includes(item.status) && item.targetTeacherName === teacherName)) }
