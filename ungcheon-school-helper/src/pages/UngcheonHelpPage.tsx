...
const NEIS_KEY_STEPS = [
  ...
  {
    title: '4. 처음 10일치 동기화',
    detail: '관리자 센터의 “관리자 동기화 — 지금 10일치 갱신”을 눌러 급식·학사일정·전체 학급 시간표를 공용 서버에 올립니다. 실패하면 기존 공용 자료가 유지됩니다.',
  },
  {
...
const SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      '관리자 센터에서는 공용 NEIS 동기화 상태와 자료 범위를 확인하고, 매일 13:00까지 기다리지 않고 “관리자 동기화 — 지금 10일치 갱신”을 실행할 수 있습니다.',
  ...
  },
  {
    ...
    items: [
      ...
      '관리자가 교직원 명렬 Excel을 한 번 등록하면 교장·교감이 먼저, 나머지 교직원이 가나다순으로 표시됩니다.',
      '관리자 편집 화면에서 “교직원 명렬 추가”를 누르면 새 행이 목록 맨 아래에 생깁니다. 입력 중에는 그 위치를 유지하고, 공유 명렬 저장 후 교장·교감 우선·가나다순으로 자동 배치됩니다.',
  ...
  },
  {
    ...
    items: [
      ...
      '학생 위치 찾기에서는 학번 4·5자리 또는 이름으로 현재 교시의 수업·교실·담당 교사를 확인합니다. 동명이인은 학번·학급으로 선택하며 승인된 교환·대강도 반영됩니다.',
