...
const SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      '대시보드와 통합 캘린더 상단의 “NEIS 학사일정 켜기”를 해제하면 NEIS 일정만 숨길 수 있으며 선택은 이 PC에 저장됩니다.',
      ...
      '왼쪽 메뉴는 그룹 없이 전체 항목이 표시됩니다. 메뉴를 펼쳐 “목록 순서 변경”을 누른 뒤 이동 손잡이를 끌면 현재 PC에 순서가 저장되며 초기화 버튼으로 기본 순서를 복원할 수 있습니다.',
