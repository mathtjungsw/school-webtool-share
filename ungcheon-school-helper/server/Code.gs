...
const RELEASE_NOTES = [
  ...
  },
  {
    ...
    body: [
      '· 바탕화면 미니 위젯을 모듈형으로 확장해 필요한 항목만 켜고 끄며 순서와 정보 밀도를 조절할 수 있게 했습니다.',
      '· 현재 교시 종료와 다음 실제 수업까지 남은 시간을 표시하고, 내일 첫 수업·주요 일정·지도 일정을 미리 확인할 수 있게 했습니다.',
      '· 오늘의 빠른 메모, 자주 쓰는 메뉴 바로가기, 날씨 행동 알림과 업무 마감 타임라인을 선택해서 사용할 수 있게 했습니다.',
      '· QR 코드, 자주 쓰는 문구, 학번·이름 정리, 날짜·기간·시간 합계·글자 수 계산을 위젯 안의 빠른 도구로 제공합니다.',
      '· 퇴근 무렵에는 미완료 업무와 내일 첫 일정·수업을 한 장으로 요약하며, 알림을 오늘만 닫거나 잠시 미룰 수 있게 했습니다.',
      '· 메모와 도구의 저장 자료는 현재 PC에서만 처리하며, 외부 연결이 불안정해도 가능한 위젯 기능은 계속 표시되도록 안정성을 높였습니다.',
      '· 위젯 바로가기로 프로그램을 처음 여는 경우에도 요청한 메뉴가 정확히 열리도록 하고 화면 높이에 맞춰 위젯 크기를 자동 조정합니다.'
    ].join('\n'),
    date: '2026-08-30'
  },
  {
    key: 'v1.1.24',
    title: '[업데이트] 웅천고 업무도우미 v1.1.24',
    body: [
      '· 학생 위치 찾기에 “학생 특정 시간 위치찾기” 탭을 추가해 여러 학생의 날짜·교시별 수업, 위치와 담당 교사를 한 번에 조회할 수 있게 했습니다.',
      '· 전용 Excel 양식을 내려받아 학번 또는 이름만 입력할 수 있으며, 4·5자리 학번 정규화, 동명이인 전체 표시와 학번·이름 불일치 검증을 제공합니다.',
      '· 도움반 개인 시간표와 승인된 교환·대강, 당김수업, 특정 요일 운영을 반영하고 승인 대기·나만 우선 반영은 확인 필요 상태로 구분합니다.',
      '· 정상·불일치·동명이인·변경 반영·확인 필요 필터와 A4 가로 인쇄, 서식이 적용된 Excel 결과 다운로드를 지원합니다.',
      '· 업로드한 학생 명단과 조회 결과는 학교 공유 서버나 구글시트로 전송하지 않고 현재 PC에서만 처리합니다.',
      '· 검색도우미에 여러 학생 위치 일괄 조회와 Excel 양식 사용 절차를 추가했습니다.'
    ].join('\n'),
    date: '2026-08-30'
  },
  {
    key: 'v1.1.21',
    title: '[업데이트] 웅천고 업무도우미 v1.1.21',
    body: [
      '· 표·글자·배지의 가독성을 위해 화면을 밝은 모드로 단일화하고 다크 모드와 시간별 자동 전환을 제거했습니다.',
      '· 이전 버전에서 자동 또는 다크 모드를 선택한 PC도 업데이트 후 첫 실행 시 밝은 모드로 자동 전환됩니다.',
      '· 상단의 테마 전환 버튼과 환경설정의 테마 선택지를 제거하고 밝은 모드 고정 안내를 표시합니다.',
      '· 시간표 업무 담당자 표의 머리글·교사명 고정열·수업 셀을 흰색·연회색 배경과 진한 글자로 교정했습니다.',
      '· 요일 시작선을 명확히 하고 교환·대강, 당김수업, 충돌 경고를 밝은 파스텔 배경과 진한 글자로 구분했습니다.',
      '· 배포 전 자동 글자 대비 검사와 이후 UI 검토 기준을 밝은 모드로 전환하고 검색도우미·사용 안내를 갱신했습니다.'
    ].join('\n'),
    date: '2026-08-25'
  },
  {
    key: 'v1.1.20',
    title: '[업데이트] 웅천고 업무도우미 v1.1.20',
    body: [
      '· 교환·대강 계획 메뉴를 교사 시간표로 개편하고, 로그인한 본인의 주간·월간·날짜별 예상 시간표를 확인할 수 있게 했습니다.',
      '· 월간 교사 시간표는 날짜마다 1~7교시 고정 칸으로 표시하며, 학사일정·특정 요일 운영·교환·대강·당김수업을 합쳐 인쇄·PDF에도 같은 구조로 반영합니다.',
      '· 시간표 업무 담당자 탭에서 모든 교사의 주간 시간표를 교과·요일·교시별로 점검하고 변경사항과 함께 Excel로 내려받을 수 있게 했습니다.',
      '· 통합 알림·변경센터를 추가해 내 업무, 위원회 일정, 수업 교환·대강 변경을 처리 필요·참고·완료로 나누고 읽음 또는 내일까지 미루기로 정리할 수 있게 했습니다.',
      '· 시간표 업무 담당자 표의 밝은 모드 배경·글자·요일 구분선을 개선하고 다크 모드와 함께 글자 대비를 점검했습니다.',
      '· 환경설정에 숨긴 메뉴 관리를 연결해 개별 메뉴 또는 전체 메뉴를 앱 재시작 없이 즉시 복원할 수 있게 했습니다.',
      '· 검색도우미에 교사 시간표, 시간표 업무 담당자, 통합 알림·변경센터와 숨긴 메뉴 복원 안내를 반영했습니다.'
    ].join('\n'),
    date: '2026-08-25'
  },
  {
