...
place_image(c, OVERVIEW, 38, 72, 560, 382)
number_note(c, 1, "이번 주·다음 주 일정", "학교 일정과 개인 관련 일정을 2주 달력으로 한꺼번에 확인합니다.", 620, 432, 180)
number_note(c, 2, "개인 시간표", "오늘 수업과 주간 시간표, 변경 수업과 당김수업을 함께 확인합니다.", 620, 363, 180, TEAL)
...
place_image(c, CALENDAR, 35, 61, 515, 396)
number_note(c, 1, "표시할 일정 직접 선택", "종류별 체크 버튼으로 보고 싶은 일정만 켜고 끌 수 있습니다. NEIS 학사일정은 기본적으로 꺼져 있습니다.", 575, 438, 230, BLUE)
number_note(c, 2, "이번 주 일정", "오늘을 포함한 이번 주 일정을 크게 보여주어 아침에 빠르게 훑어보기 좋습니다.", 575, 351, 230)
number_note(c, 3, "다음 주 일정", "바로 다음 주까지 이어서 보여주므로 다가오는 업무를 미리 준비할 수 있습니다.", 575, 274, 230, TEAL)
...
place_image(c, TIMETABLE, 42, 58, 290, 397)
number_note(c, 1, "원래 주간 시간표", "교시별 학급·과목을 확인하고, 오늘 수업이 끝났는지도 바로 알 수 있습니다.", 360, 435, 430, TEAL)
number_note(c, 2, "수업교체 반영", "승인된 수업교체는 원래 시간표와 구분되는 색으로 표시됩니다.", 360, 365, 430)
number_note(c, 3, "당김수업 반영", "관리자가 등록한 당김수업도 해당 날짜·교시에 자동으로 추가됩니다.", 360, 300, 430, HexColor("#D97706"))
...
place_image(c, TOP, 38, 212, 765, 245)
groups = [
...
place_image(c, SELECTED, 45, 225, 750, 230)
number_note(c, 1, "선택한 날짜의 일정", "당김수업, 지도 일정, 위원회 등 그날 확인할 항목을 한곳에 모아 보여줍니다.", 70, 180, 330)
number_note(c, 2, "기타·참고사항", "청렴교육, 안전, 복무 등 주간계획 시트의 공통 참고사항도 함께 확인할 수 있습니다.", 440, 180, 330, TEAL)
...
place_image(c, WEATHER_MEAL, 40, 85, 550, 370)
number_note(c, 1, "오늘 날씨와 주간 예보", "현재 기온·습도·풍속·미세먼지와 일주일 예보를 확인합니다.", 620, 425, 180, BLUE)
number_note(c, 2, "오늘과 다음 날 급식", "중식·석식 메뉴와 열량을 확인합니다. 관리자 동기화 자료를 사용하므로 일반 사용자는 API 키를 따로 넣지 않습니다.", 620, 326, 180, HexColor("#D97706"))
