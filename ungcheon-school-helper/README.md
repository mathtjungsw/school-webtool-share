...
- 공문알리미
- 학교 공지 및 부서별 공유 링크
- 사용자·관리자 모드 및 실명 기능개선 요청 게시판
- 교사 시간표 교체 후보 찾기 및 관리자 시간표 업로드
...
공유 서비스에는 공지, URL, 작성자가 실명으로 등록한 기능개선 요청과 교직원용 시간표를 저장합니다.
시간표 Excel 원본과 VBA 코드는 전송하지 않으며, 학생·학부모 개인정보와 업무 원본 자료는 저장하지 않습니다.
